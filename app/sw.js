/* CardTrack Meet OS service worker 58f512783251 */
const CACHE = 'cardtrack-shell-58f512783251';
const SHELL = ['./','./index.html','./assets/app.css','./assets/app.js','./manifest.webmanifest','./version.json','./icons/icon.svg'];
